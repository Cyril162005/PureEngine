...
- Next active system: physics swept consumer on request (sweptAABB/sweptMoveAndCollide are API-only, no game wire). Otherwise blank— all assigned campaigns COMPLETE:
