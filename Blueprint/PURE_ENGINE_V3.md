# PureEngine â€” Build Continuation (v3)
...
- Sound effects tied to real events (catch, game over, high score) â€” check the existing audio boundary before proposing any new API
- Visually distinct hostile types (not just speed variance) â€” check the existing renderer texture-by-index convention before proposing new work
